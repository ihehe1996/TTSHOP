...
<head>
    ...
    <link href="<?= BLOG_TEMPLATE_URL ?>css/style.css?v=<?= $v ?>&t=<?= Option::TT_VERSION_TIMESTAMP ?>" rel="stylesheet" />
    <link href="<?= BLOG_TEMPLATE_URL ?>css/icon/iconfont.css?v=<?= $v ?>&t=<?= Option::TT_VERSION_TIMESTAMP ?>" rel="stylesheet" />
    <link href="<?= BLOG_TEMPLATE_URL ?>css/markdown.css?v=<?= $v ?>&t=<?= Option::TT_VERSION_TIMESTAMP ?>" rel="stylesheet" />
    <script src="../../../admin/views/js/jquery.min.3.5.1.js?v=<?= $v ?>&t=<?= Option::TT_VERSION_TIMESTAMP ?>"></script>
    <script src="<?= BLOG_TEMPLATE_URL ?>js/common_tpl.js?v=<?= $v ?>&t=<?= Option::TT_VERSION_TIMESTAMP ?>"></script>
    <script src="<?= BLOG_TEMPLATE_URL ?>js/zoom.js?v=<?= $v ?>&t=<?= Option::TT_VERSION_TIMESTAMP ?>"></script>
    ...
    <nav class="blog-header">
        <div class="blog-header-c container">
            <?php if (!empty(Option::get('logo'))): ?>
                <a class="blog-header-title" href="<?= TT_URL ?>" title="<?= $bloginfo ?>">
            ...
            <?php else: ?>
                <?php if (_em('logotype') == 1): ?>
                    <a class="blog-header-title" href="<?= TT_URL ?>"><?= $blogname ?></a>
                    <div class="blog-header-subtitle subtitle-overflow" title="<?= $bloginfo ?>"><?= $bloginfo ?></div>
                <?php else: ?>
                    <a href="<?= TT_URL; ?>" title="<?= $bloginfo; ?>" style="color: #007bff; font-size: 1.5rem; font-weight: bold;"><?= $blogname ?></a>
                <?php endif; ?>
            <?php endif; ?>
