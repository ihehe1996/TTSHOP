...
// 获取对接信息
$ttGoods = $db->once_fetch_array("SELECT * FROM " . DB_PREFIX . "em_goods WHERE goods_id = " . (int)$goodsId);
...
$specInfo = function_exists('ttGetRemoteSpecInfo') ? ttGetRemoteSpecInfo($goodsId) : null;
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-fluid" style="padding: 15px;">
    <div class="tt-stock-card">
        <div class="layui-card-body">
            <div class="tt-meta">
                <div class="tt-meta-item"><strong>商品类型：</strong><?php echo $goodsRow['type'] == 'em_auto' ? 'EM对接(自动发货)' : 'EM对接(人工发货)'; ?></div>
                    ...
                    <tr>
                        <td>
                            ...
                            if ($sku['option_ids'] == '0') {
                                ...
                                echo htmlspecialchars(rtrim(ttFormatSkuOptionIds($goodsId, $sku['option_ids']), '；'));
                            } else {
