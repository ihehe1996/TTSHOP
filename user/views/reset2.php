...
<div class="reset-page">
    <div class="reset-card">
        <div class="reset-banner">
            ...
            <div>
                <div class="banner-tag">STEP 2 / 2</div>
                <h2>重置密码</h2>
                <p>填写邮件验证码与新密码，完成后即可回到登录页。</p>
            </div>
        </div>
        ...
        <form method="post" class="user" action="./account.php?action=doreset2">
            <div class="field">
                <label for="mail_code">邮件验证码</label>
            ...
            <div class="password-hint">密码长度至少 6 位，建议数字与字母组合。</div>
            ...
            <div class="reset-divider">完成后</div>
