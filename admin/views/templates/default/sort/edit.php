            ...
            <div class="form-card">
                <div class="form-section">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="sortname" class="layui-input" value="<?= $data['sortname'] ?>" placeholder="请输入分类名称">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">别名</label>
                        <div class="layui-input-block">
                            <input type="text" name="alias" class="layui-input" value="<?= $data['alias'] ?>" placeholder="可选，便于识别">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <select class="layui-input" name="pid">
                                ...
                                ?>
                                    <option <?= $key == $data['pid'] ? 'selected' : '' ?> value="<?= $key ?>"><?= $val['sortname'] ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <div class="upload-field">
                                <div id="sortimg-preview-wrapper" class="upload-preview-thumb <?= empty($data['sortimg']) ? 'placeholder' : '' ?>" title="点击预览分类图片">
                                    <img id="sortimg-preview-img" src="<?= $data['sortimg'] ?>" alt="" style="display: <?= !empty($data['sortimg']) ? 'block' : 'none' ?>;" />
                                </div>
                                <input type="text" value="<?= $data['sortimg'] ?>" placeholder="分类图片地址" class="layui-input upload-input" name="sortimg" id="sortimg">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="number" name="taxis" class="layui-input" value="<?= $data['taxis'] ?>" placeholder="数值越大越靠前">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="title" class="layui-input" value="<?= $data['title'] ?>" placeholder="例如：{{sort_name}} - {{site_name}}">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">关键词（用于分类页的 keywords，英文逗号分割）</label>
                        <div class="layui-input-block">
                            <textarea class="layui-textarea" name="kw" placeholder="多个关键词用英文逗号分隔"><?= $data['kw'] ?></textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">描述（用于分类页的 description）</label>
                        <div class="layui-input-block">
                            <textarea class="layui-textarea" name="description" placeholder="建议 80-120 字"><?= $data['description'] ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
