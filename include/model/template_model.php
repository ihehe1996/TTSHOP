...
class Template_Model {
    ...
    function getCurrentTemplate(){
        ...
        if(STATION_DATA){
            $nonce_template = isMobile() ? STATION_DATA['tel_tpl'] : STATION_DATA['pc_tpl'];
        }else{
...
//        ksort($templates);
    ...
    function getStationTemplates($userData, $includeAll = false){
        ...
        while ($file = @readdir($handle)) {
            ...
            $previewPath = TPLS_PATH . $file . '/preview.jpg';
            $tplInfo['preview'] = file_exists($previewPath) ? ($tpl_url . $file . '/preview.jpg') : './views/images/theme.png';
